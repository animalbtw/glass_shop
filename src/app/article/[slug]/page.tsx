  ...
  return (
    <div className={style.wrapper}>
      <div className={style.page_title}>
        ...
        <div style={{right: 0, zIndex: '0'}} className={style.image_container}>
          <Image src={rightSide} alt={'img'}/>
        </div>
        <div style={{left: '65%', bottom: 0, zIndex: '0'}} className={style.image_container}>
          <Image src={doc} alt={'img'}/>
        </div>
        <div className={style.page_title_container}>
          <div className={style.breadcrumbs}>
            <Breadcrumbs chain={[{text: 'Главная', href: '/'}, {text: 'Диагностика зрения', href: ''}]}/>
          </div>
      ...
      <div className={style.page_subtitle}>
        <div className={style.page_subtitle_container}>
          <div className={style.subtitle_content}>
            Каждое обследование глаз в наших оптиках проводится на современном высокоточном оборудовании, в соответствии
            с вашими индивидуальными потребностями и мерами безопасности в связи с COVID-19
          </div>
        </div>
      </div>
      <div className={style.container_wrapper}>
        <Container>
          ...
          <div className={style.image_banner}>
            <Image src={wide_pic} layout={'fill'}/>
          </div>
          <div className={style.benefits}>
            <ul>
              <li className={style.benefit}>
                <div className={style.benefit_text}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
